...
<div class="containerpre" style="            background-color: #ded4d4;
            background-image: linear-gradient(180deg, #ded4d4 0%, #6284FF 50%, #f47070 100%); padding-top: 15vh; height: 400vh;">

    <div class="container" >

        <p style="font-size: 5vh; text-align: center; ">ADD CAR DETAILS</p>
        
        <div class="container_1" style="width: 70vw; height: 300vh;
        background-color: rgb(255, 255, 255); margin: 10vh 0vw 0vh 15vw; border: 0.15vw solid rgb(197, 194, 194); 
        border-radius: 1.5vw;">
        

            <form action="cardsthapa.php"  method="post" name="addcar" enctype="multipart/form-data">
                    ...
                    <div class="fuel">
                        ...
                        <div class="fueltype-input" style="margin:2vh 0 0 15vw;">
                            ...
                            font-size: 2.3vh; cursor:pointer;">
                                ...
                                <option value="NO" style="background-color: rgba(128, 126, 126, 0.139); font-size: 2.2vh; color: rgba(171, 28, 28, 0.858);">Select Fuel Type</option>
...
<footer style=" margin: 0; padding: 0; width: 98.6vw; height: 50vh; background-color: #0e3a50;">

<img src="/carsandbids.png" height=90vh; style="margin:10vh 0 0 42vw;"  alt="">
<br>
<br>
